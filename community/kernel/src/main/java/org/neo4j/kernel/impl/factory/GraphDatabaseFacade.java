    ...
    implements GraphDatabaseAPI
{
    ...
    public void init( ThreadToStatementContextBridge threadToTransactionBridge,
                                NodeManager nodeManager, IndexManager indexManager, Schema schema,
                                AvailabilityGuard availabilityGuard, StringLogger msgLog, LifeSupport life,
                                Supplier<KernelAPI> kernel, Supplier<QueryExecutionEngine> queryExecutor,
                                KernelEventHandlers kernelEventHandlers,
                                TransactionEventHandlers transactionEventHandlers, long transactionStartTimeout,
                                DependencyResolver dependencies, Supplier<StoreId> storeId, String storeDir )
    {
        ...
        this.transactionStartTimeout = transactionStartTimeout;
